	...
	<div class="columns">
		...
		<div class="column is-8">
			<div class="box" data-aos="flip-right" data-aos-duration="800" data-aos-once="true">
				...
				<p class="has-text-centered has-text-grey"><i class="fas fa-info-circle"></i>&thinsp;此处显示的假条均已通过医生批准</p>
				<br>
					<?php
						if(empty($leave_list)):
					?>
						<p class="has-text-centered">暂无病人假条</p>
					<?php
						else:
					?>
					...
					?>
								<tr>
									...
									<td>
										<a href="./patient_detail.php?id=<?=$row['patient_id']?>">
											<?=$row['name']?>
										</a>
									</td>
									<td>
