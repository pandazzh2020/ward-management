						  ...
						  <div class="columns">
							  ...
							  <div class="column">
									...
									<figure class="image is-2by1">
										<img src="./_share/_captch.php"  onclick="this.src='./_share/_captch.php?'+new Date().getTime();" width="200" height="200">
<!-- 										<img src="./_share/_captch.php"/>
 -->									</figure>
					...
					<div class="field is-inline-block">
						<div class="control">
						  <label class="radio">
							<input type="radio" name="type" value="patient" checked="checked">
							患者&nbsp;
						  </label>
						  <label class="radio">
