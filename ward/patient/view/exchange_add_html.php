				...
				<form method="post" action="exchange_add.php">
					<table style="width: 100%;border-collapse:separate; border-spacing:0px 10px;">
						...
						<tr>
							...
							<td style="padding-left: 15px;">
								<?=isset($ward_building)?$ward_building." 号楼 ".$ward_number." 户":"未安排"?>
							</td>
						</tr>
						<tr>
							<td colspan="3">
						...
						<tr>
							...
							<td>
								<input type="text" class="input" name="building" required="required" maxlength="10" placeholder="目标宿舍楼座" value="<?=isset($to_ward_building)?$to_ward_building:''?>" />
							</td>
							<td>
								<span>&emsp;号楼</span>
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" class="input" name="number" required="required" maxlength="10" placeholder="目标病房门牌号" value="<?=isset($to_ward_number)?$to_ward_number:''?>" />
							</td>
							<td>
								<span>&emsp;户</span>
							</td>
						...
						<tr>
							<td colspan="3">
								<textarea class="textarea" name="request" rows="6" maxlength="200" required="required" placeholder="请输入申请更换病房的原因..."><?=isset($request)?$request:''?></textarea>
							</td>
						</tr>
						<tr>
